...
*/
create type content_access_role as enum ('free', 'basic', 'premium');
...
create table posts (
  ...
  access_level content_access_role default 'free',
  title text not null,
...
/**
 * Create some basic posts to get us started.
 */

insert into posts (title, content, access_level)
values
 ('Hello World', 'Stripe + Vercel + Supabase ❤️', 'free'),
 ('Basic content', 'Stripe + Vercel + Supabase ❤', 'basic'),
 ('Premium content', 'Stripe + Vercel + Supabase ❤', 'premium');
️