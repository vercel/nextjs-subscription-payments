...
create type pricing_plan_interval as enum ('day', 'week', 'month', 'year', 'lifetime');
create table prices (
  ...
  type pricing_type,
  -- The frequency at which a subscription is billed. One of `day`, `week`, `month`, `year`, or 'one_time`.
