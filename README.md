...
Otherwise navigate to the [SQL editor](https://app.supabase.com/project/_/sql/new) and paste the contents of the [Supabase migration file](./supabase/migrations/20230530034630_init.sql) to set up the Database schema.
